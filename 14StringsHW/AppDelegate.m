...
//  14StringsHW
//
//  Created by Eduard Galchenko on 8/15/18.
...
#pragma mark - Level "Learner"
    ...
    NSLog(@"Text Length = %ld", (long)textLength);
    NSLog(@" ");
    
    NSLog(@"First part of text: %@", [text substringToIndex:textLength/2]);
    NSLog(@" ");
    NSLog(@"Second part of text: %@", [text substringFromIndex:textLength/2]);
    NSLog(@" ");
...
#pragma mark - Level "SuperMan"
    ...
    // Make all letters from lover case
    ...
    // In reversed text make all letters from lover case
    reversedString = (NSMutableString*) [reversedString capitalizedString];
    //NSLog(@"%@", reversedString);
    
    //********************************************************
    
    //Reverse text to original with last letters capitalized
    NSMutableString *reversedString2 = [NSMutableString string];
    
    NSInteger charIndex2 = [reversedString length];
    while (charIndex2 > 0) {
        charIndex2--;
        NSRange subStrRange2 = NSMakeRange(charIndex2, 1);
        [reversedString2 appendString:[reversedString substringWithRange:subStrRange2]];
    }
    
    //reversedString2 = (NSMutableString*) [reversedString capitalizedString];
    NSLog(@"%@", reversedString2);
...
//NSLog(@"%ld", (long)[@"512" integerValue]);
